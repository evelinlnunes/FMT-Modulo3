...
class ConsultaControllerIntegracaoTest {
    ...
    static void setUpBeforeClass() throws Exception {
        paciente = new Paciente(1L, "João Silva", LocalDate.of(1990, 1, 1), "111.111.111-11", "99999999", "joao@email.com");
        nutricionista = new Nutricionista(1L, "João Silva", "12345", 3, "12345678", "Esportiva", Set.of("Certificação A", "Certificação B"));
    }
