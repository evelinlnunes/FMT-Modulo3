...
class NutricionistaServiceTest {
    ...
    @BeforeEach
    void setUp() {
        nutricionista1 = new Nutricionista(1L, "João Silva", "12345", 3, "12345678", "Esportiva", Set.of("Certificação A", "Certificação B"));
        nutricionista2 = new Nutricionista(2L, "Maria Souza", "54321", 5, "87654321", "Clínica", Set.of("Certificação C", "Certificação D"));
    }
    ...
    void salvarNutricionistaDuplicado() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> service.salvarNutricionista(request));
